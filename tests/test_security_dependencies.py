...
from forksure.security.dependencies import PYTHON_LOCKFILES, scan_dependencies
...
def test_dependency_scan_for_forksure_does_not_report_missing_python_lockfile() -> None:
